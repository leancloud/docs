...
我们建议优先选择 [Google Firebase](https://firebase.google.com/) 作为替代方案，如果希望采用自建开源方案以降低成本，
则推荐使用 [Parse Platform](https://github.com/parse-community/parse-server) 进行自行搭建与部署。
